...
# Read Brent daily spot price data [2]
data_path = "data/DCOILBRENTEU.csv"
...
"""
data_dir = "data"
output_filename = "brent_prices_daily_raw.csv"
...
ax.set_title("Brent Blend Daily Spot Price")
ax.set_xlabel("Date")
ax.set_ylabel("USD")
...
fig.savefig("results/figures/brent_daily_spot_price.png")
...
fig.savefig("results/figures/brent_week_excess_returns_percent.png")
...
fig.savefig("results/figures/brent_week_task_smooth_probs.png")
...
fig.savefig("results/figures/brent_week_task_labels.png")
...
axes[0].plot(x, y)
axes[0].set_title("Brent Blend Crude Oil Daily Spot Price")
...
fig.savefig("results/figures/brent_all_plots.png")

"""
This outputs resampled data and corresponding task labels.
"""
data_copy['DATE_DT'] = pd.to_datetime(data_copy['DATE'])
data_copy['DCOILBRENTEU'] = pd.to_numeric(data_copy['DCOILBRENTEU'], errors='coerce')
...
output_filename = "brent_prices_tasks_resamp_week.csv"
output_filepath = os.path.join(data_dir, output_filename)
if not os.path.exists(data_dir):
    os.mkdir(data_dir)
